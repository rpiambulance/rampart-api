...
const crews_jobs_1 = require("./crews.jobs");
...
exports.CrewsModule = CrewsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [crews_service_1.CrewsService, crew_eligibility_service_1.CrewEligibilityService, crews_jobs_1.CrewsJobs],
        exports: [crews_service_1.CrewsService],
    })
], CrewsModule);
